...
export const grainOptions = ['Off', 'Weak / Small', 'Weak / Large', 'Strong / Small', 'Strong / Large']
...
export const isoOptions = ['Auto', 'ISO 160', 'ISO 320', 'ISO 640', 'ISO 1250', 'ISO 2500', 'ISO 5000']
