...
import RecipeValidationList from '@/features/recipes/RecipeValidationList'
import {
	cameraSensorOptions,
	clarityOptions,
	colorChromeOptions,
			...
			<form onSubmit={handleSubmitRecipe} className="form-grid recipe-form">
				<label>
					...
					<input
						...
						onChange={(event) =>
							setForm((prev) => ({ ...prev, recipeName: event.target.value }))
						}
						required
					/>
				</label>
				...
				<label>
					...
					<select
						...
						onChange={(event) =>
							setForm((prev) => ({ ...prev, cameraSensor: event.target.value }))
						}
					>
				...
				<label>
					...
					<select
						...
						onChange={(event) =>
							setForm((prev) => ({ ...prev, colorChromeEffect: event.target.value }))
						}
					>
				...
				<label>
					...
					<select
						...
						onChange={(event) =>
							setForm((prev) => ({ ...prev, colorChromeFxBlue: event.target.value }))
						}
					>
						{colorChromeOptions.map((option) => (
							<option key={option} value={option}>
				...
				<label>
					...
					<select
						...
						onChange={(event) =>
							setForm((prev) => ({ ...prev, whiteBalance: event.target.value }))
						}
					>
				...
				<label>
					...
					<select
						...
						onChange={(event) =>
							setForm((prev) => ({ ...prev, dynamicRange: event.target.value }))
						}
					>
				...
				<label>
					...
					<select
						...
						onChange={(event) =>
							setForm((prev) => ({ ...prev, sharpness: event.target.value }))
						}
					>
						{tonalRangeOptions.map((option) => (
							<option key={option} value={option}>
				...
				<label>
					...
					<select
						value={form.clarity}
						onChange={(event) =>
							setForm((prev) => ({ ...prev, clarity: event.target.value }))
						}
					>
				...
				<label>
					...
					<select
						...
						onChange={(event) =>
							setForm((prev) => ({ ...prev, expCompensation: event.target.value }))
						}
					>
